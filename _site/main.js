...
(function () {
  ...
  var wrapper = document.getElementById('main_content'),
    ...
    externalPreview = function (source) {
      ...
      source =
        '<html><head><meta charset="utf-8"><link rel="shortcut icon" type="image/png" href="http://localhost:4000/de4js/favicon.png"><title>pxxjs | Preview</title><style>' +
        externalStyle +
    ...
    format = debounce(function () {
      ...
      if (!workerFormat) {
        workerFormat = new Worker('/de4js/worker/format.js');
    ...
    decode = debounce(function () {
      ...
      if (!workerDecode) {
        workerDecode = new Worker('/de4js/worker/decode.js');
